...
Route::match(['get', 'post'], '/search/{search}', [BookController::class, 'SearchBooks'])->name('search');
...
Route::middleware(['auth', AdminMiddleware::class])->group(function() {
    ...
    Route::delete('admin/delete-review', [RatingController::class, 'DeleteReview'])->name('admin.review.delete');
