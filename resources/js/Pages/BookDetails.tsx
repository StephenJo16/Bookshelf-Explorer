...
import { calcRating, formatDate } from "@/Utils/util";
                ...
                <div className="max-w-6xl mx-auto py-6 px-6 lg:py-8 lg:px-8 bg-white shadow-sm sm:rounded-lg">
                    <div className="flex flex-col sm:flex-row gap-8">
                        ...
                        <div className="flex-1 flex flex-col gap-3">
                            ...
                            <p className="text-xl">{book.genres.map(genre => `${genre.genre_name}, `)}</p>
                    ...
                    <br />
                    <BookReviews book={book} reviews={reviews} user={auth.user}/>
                </div>
            </div>
            <ToastContainer
                position="top-right"
